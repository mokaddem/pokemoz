...
/*trainer 1*/
	...
	in 
		...
		Trainer1 = {NewTrainer state(x:TrainerPosX1 y:TrainerPosY1 pokemoz:PokeTrainer1 speed:5 movement:{RandomMove Trainer1 TrainerFrames1} handler:TrainerHandle1 number:1 movementStatus:idle() type:'ia')}
	end
...
/*trainer 2*/
	...
	in 
		...
		TrainerFrames1 = TrainerCreation.frames
		PokeTrainer1 = {NewPokemoz state(type:grass num:7 name:squirtOz maxlife:20 currentLife:20 experience:0 level:5)}
		Trainer1 = {NewTrainer state(x:TrainerPosX1 y:TrainerPosY1 pokemoz:PokeTrainer1 speed:5 movement:{RandomMove Trainer1 TrainerFrames1} handler:TrainerHandle1 number:2 movementStatus:idle() type:'ia')}
	end
...
/*trainer 3*/
	...
	in 
		...
		TrainerFrames1 = TrainerCreation.frames
		PokeTrainer1 = {NewPokemoz state(type:grass num:7 name:squirtOz maxlife:20 currentLife:20 experience:0 level:5)}
		Trainer1 = {NewTrainer state(x:TrainerPosX1 y:TrainerPosY1 pokemoz:PokeTrainer1 speed:5 movement:{RandomMove Trainer1 TrainerFrames1} handler:TrainerHandle1 number:3 movementStatus:idle() type:'ia')}
	end
...
/*trainer 4*/
	...
	in 
		...
		TrainerFrames1 = TrainerCreation.frames
		PokeTrainer1 = {NewPokemoz state(type:grass num:7 name:squirtOz maxlife:20 currentLife:20 experience:0 level:5)}
		Trainer1 = {NewTrainer state(x:TrainerPosX1 y:TrainerPosY1 pokemoz:PokeTrainer1 speed:5 movement:{RandomMove Trainer1 TrainerFrames1} handler:TrainerHandle1 number:4 movementStatus:idle() type:'ia')}
	end
